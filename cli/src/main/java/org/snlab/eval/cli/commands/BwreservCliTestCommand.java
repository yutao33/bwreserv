 ...
 */
package org.snlab.eval.cli.commands;
...
public class BwreservCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(BwreservCliTestCommand.class);
    protected final BwreservCliCommands service;

    public BwreservCliTestCommand(final BwreservCliCommands service) {
